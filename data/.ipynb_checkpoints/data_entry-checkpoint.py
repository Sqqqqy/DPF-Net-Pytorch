...
def get_dataset_by_type(args, is_train=False):
    type2data = {
        ...
        'shapenet': ShapeNetDataset(args, is_train),
    }
...
def select_train_loader(args):
    ...
    train_loader = DataLoader(train_dataset, args.batch_size, shuffle=True, num_workers=0, pin_memory=True, drop_last=False)
    return train_loader
