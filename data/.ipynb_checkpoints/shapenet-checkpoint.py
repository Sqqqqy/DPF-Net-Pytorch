...
class ShapeNetDataset(Dataset):
    def __init__(self, args, dataset_type='train'):
        ...
        self.args = args
        if args.SVR:
            data_dict = h5py.File('/home/sist/cq14/kBAE/dataset/shapenet/02691156_airplane/02691156_train_vox.hdf5', 'r')
            ...
            if self.args.SVR_z:
                 self.z_list = np.load('/home/sist/cq14/kBAE/code/RIM-Net-main/z_out.npy')
        else:
            if dataset_type == 'train':
                data_path = args.shapenet_path
            elif dataset_type == 'val':
