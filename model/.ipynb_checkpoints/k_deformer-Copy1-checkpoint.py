...
class k_deformer(nn.Module):
    def __init__(self, hidden_size=128, z_dim=512, num_template=4):
        super().__init__()
        self.hidden_size = hidden_size
        self.z_dim = z_dim
        self.activation = nn.ReLU()
        ...
        self.split_layer = nn.Linear(self.z_dim, self.num_template*64)
        
        self.deformer = deformer()
        self.h6 = nn.Linear(self.hidden_size,3*self.num_template+1)
